...
namespace JM2D.Debugging
{
    ...
    /// 초당 일정한 수를 사방으로 발사해 Instantiate 와 Destroy 를 반복시킨다.
    /// </summary>
    public class ProjectileStressSpawner : MonoBehaviour
    {
        ...
        [SerializeField] private int _perSecond = 200;
        ...
        private void SpawnOne()
        {
            ...
            Projectile projectile = Instantiate(_prefab, transform.position, Quaternion.identity);
